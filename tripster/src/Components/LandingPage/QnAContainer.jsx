...
import styles from './FooterAndQnA.css'

const QnDetailsContainer = () => {
    return (
        <>
            <Grid className='DetailsContainer' style={styles} fontSize={{ base: '10px', md: '10px', lg: '14px' }} gap='4'>
                <Box>
                ...
                <Box>
                    <Heading as={'h2'} size='xs'>MAKEMYTRIP</Heading>
            ...
            <Grid className='QnAContainer' style={styles} id='aboutWebsite' w='100%' h={'auto'} justify='space-around' align='center' color='black' gap='5' fontSize={{ base: '10px', md: '10px', lg: '14px' }} templateColumns={{ md: 'repeat(1, 1fr)', lg: 'repeat(3, 1fr)' }} textAlign={'left'} p={{ lg: '50, 150', md: '20, 100' }}>
                <Box w={'auto'} >
                    <Heading as={'h2'} size='md' p={'20px 0'}>Why MakeMyTrip?</Heading >
                ...
                <Box w={'auto'} >
                    <Heading as={'h2'} size='md' p={'20px 0'}>Booking Flights with MakeMyTrip</Heading>
                ...
                <Box w={'auto'} t='0'>
                    <Heading as={'h2'} size='md' p={'20px 0'}>Domestic Flights with MakeMyTrip</Heading>
